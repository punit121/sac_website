...
background-image:url('img/vinay.png');width:1315px;background-repeat:no-repeat;margin-left:15px;	}
  ...
  <h2>Associate With Us  </h2><hr><br><br>
					...
					<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#registermentor"  style="width:200px;">
						Join Us
					</button>
...
<div class="field">
 <input type="text" name="Person_Name" style="width:500px;padding:6px;border-radius:5px;" placeholder="Person Name" required><br><br>
</div>

<div class="field">
   <input type="text" name="Company_Name" style="width:500px;padding:6px;border-radius:5px;" placeholder="Company Name" required><br><br>
</div>

<div class="field">
   <input type="email" name="Email_Id" style="width:500px;padding:6px;border-radius:5px;" placeholder="Email Id"  required ><br><br>
</div>

<div class="field">
   <input type="text" name="123" style="width:500px;padding:6px;border-radius:5px;" maxlength="10" placeholder="Phone No." required><br><br>
</div>


<div class="field">
   <input type="text" name="Address" style="width:500px;padding:6px;border-radius:5px;" placeholder="Address" required><br><br>
</div>
...
<div class="actions">
  <input class="btn btn-primary btn-lg" name="com" type="submit" value="Submit" style="width:500px" />
</div>
</form>
				</div>
			</div>
...
<?php include 'submit_association.php'; ?>
  ...
  <h2>Contact Us</h2><br><hr>
	...
	<div class="col-md-3">
          ...
          <div class="panel panel-default">
            <div class="panel-body" style="text-align:justify;background-color:#003366;color:white;">
              <b>Ankit Sharma</b>
              <br><font size="4"> ankitsharma.iitkgp@gmail.com</font>
              <br> 
            </div>
          </div>
        </div>
