...
Each year, the Students’ Alumni Cell strives to make the yearbook as wholesome and eliciting of emotion and spirit for the alumni.</p>
		<table class="table table-condensed" style="text-align:center">
			...
			<tbody>
				<tr class="active" >
					<td>2015</td>
					<td style="padding:20px;"><img src="img\yearbook\12.jpg" height="300"></td>
					<td style="padding:20px;" ><img src="img\yearbook\12.jpg" height="300" ></td>
					<td style="padding:20px;" ><img src="img\yearbook\12.jpg" height="300" ></td>
				</tr>
				<tr class="active">
					<td >2014</td>
					<td style="padding:20px;" ><img src="img\yearbook\13.jpg" height="300" ></td>
					<td style="padding:20px;" ><a href="yearbook_2014 initialedition.pdf"><img src="img\yearbook\13.jpg"height="300"></a></td>
					<td style="padding:20px;" ><img src="img\yearbook\13.jpg"height="300"></td>
				</tr>
				<tr class="warning">
					<td>2013</td>
					<td style="padding:20px;" ><img src="img\yearbook\7.jpg" height="250"></td>
					<td style="padding:20px;" ><img src="img\yearbook\7.jpg"height="250" ></td>
					<td style="padding:20px;"><img src="img\yearbook\7.jpg"height="250" ></td>
				</tr>
				<tr class="active">
					<td>2012</td>
					<td style="padding:20px;" ><img src="http://placehold.it/200x250" height="250" ></td>
					<td style="padding:20px;" ><img src="http://placehold.it/200x250" height="250" ></td>
					<td style="padding:20px;" ><img src="http://placehold.it/200x250" height="250" ></td>
				</tr>
				<tr class="info">
					<td>2011</td>
					<td style="padding:20px;"><img src="img\yearbook\9.jpg" height="250" ></td>
					<td style="padding:20px;" ><img src="img\yearbook\9.jpg" height="250" ></td>
					<td style="padding:20px;" ><img src="img\yearbook\9.jpg" height="250" ></td>
				</tr>
			</tbody>
