...
<div class="navbar navbar-default nav_color" >
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">INITIATIVES<span class="caret"></span></a>
					 <ul class="dropdown-menu">
<li><a href="mentor.php" >MENTORSHIP PROGRAM</a></li>
					 ...
					 <ul class="dropdown-menu">
						...
						<li><a href="annualreport.php" >ANNUAL ALUMNI REPORT</a></li>
					 </ul>
					</li>
